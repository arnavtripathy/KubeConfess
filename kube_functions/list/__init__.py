...
definitions = [pods_def, deployments_def, namespaces_def, services_def, permissions_def]

def dispatch(name: str, args: dict, k8s=None, k8s_apps=None, k8s_auth=None) -> str:
    if name == "list_pods":
